...
<div class="max-w-2xl mx-auto mt-10 p-6 bg-white shadow-md rounded-xl">
        ...
        <div class="grid grid-cols-1 gap-6">
            ...
            <div class="space-y-4">
                <div class="border-b border-gray-200 pb-4">
                    ...
                    <p class="text-lg text-gray-900">{{ $inspekturUtama->id }}</p>
                </div>
    ...
    <div class="flex justify-between space-x-4">
        <a href="{{ route('admin.inspektur-utama.index') }}"
           class="bg-gray-500 hover:bg-gray-600 text-white px-6 py-2 rounded-md transition flex items-center">
        ...
        <div class="flex space-x-2">
            <a href="{{ route('admin.inspektur-utama.edit', $inspekturUtama->id) }}"
               class="bg-blue-500 hover:bg-blue-600 text-white px-6 py-2 rounded-md transition flex items-center">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button type="button"
                    ...
                    class="bg-red-500 hover:bg-red-600 text-white px-6 py-2 rounded-md transition flex items-center">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
