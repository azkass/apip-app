...
@section('content')
    ...
    <div class="flex">
        <div class="flex-auto">
            <svg xmlns="http://www.w3.org/2000/svg" class="bg-white" width="296mm" height="208mm" style="margin: 0; padding: 0; border: 1px solid gray;" id="svg-cover" xmlns:xlink="http://www.w3.org/1999/xlink">
