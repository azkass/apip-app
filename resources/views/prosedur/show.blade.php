...
@section('content')
    ...
    <div class="flex justify-between items-center mb-2 ml-8 mr-8">
        <div class="flex justify-between items-center mt-4 mx-8">
            ...
            <button id="downloadPdfBtn" class="px-2 py-1 bg-blue-500 hover:bg-blue-600 ml-8 cursor-pointer rounded-sm text-white font-semibold">Unduh PDF</button>
        </div>
    </div>
    ...
    @push('scripts')
        ...
        @vite(['resources/js/graph.js', 'resources/js/editCover.js', 'resources/js/pdfExportSOP.js'])
    @endpush
@endsection
