    ...
    <div class="flex flex-wrap items-center gap-2 sm:gap-4 mb-6">
        ...
        <div class="flex w-full sm:w-auto gap-2">
            ...
            <div class="flex flex-col w-1/2 sm:w-auto">
                ...
                <div class="relative">
                    <select
                        id="tahunDropdown"
                        class="block w-full sm:w-32 px-4 py-2 text-sm text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm appearance-none focus:ring focus:ring-blue-200"
            ...
            <div class="flex flex-col w-1/2 sm:w-auto">
                ...
                <div class="relative">
                    <select
                        id="statusDropdown"
                        class="block w-full sm:w-44 px-4 py-2 text-sm text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm appearance-none focus:ring focus:ring-blue-200"
                        onchange="window.location.href=this.value"
                    >
                        @if (Auth::user()->role == 'perencana' || Auth::user()->role == 'pjk')
        ...
        @if (Auth::user()->role == 'perencana')
            <div class="flex flex-col w-full sm:w-auto mt-2 sm:mt-0">
                ...
                <a href="{{ route('prosedur-pengawasan.create') }}" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md transition w-full sm:w-auto text-center">
                    Tambah
                </a>
            </div>
        @endif
            ...
            <table class="border-collapse w-full">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="border border-gray-300 px-2 sm:px-4 py-2 sm:py-3 text-left font-semibold">Nomor SOP</th>
                        <th class="border border-gray-300 px-2 sm:px-4 py-2 sm:py-3 text-left font-semibold">Nama SOP</th>
                        <th class="border border-gray-300 px-2 sm:px-4 py-2 sm:py-3 text-center font-semibold">Pembuat</th>
                        <th class="border border-gray-300 px-2 sm:px-4 py-2 sm:py-3 text-center font-semibold">Penyusun</th>
                        ...
                        <th class="border border-gray-300 px-2 sm:px-4 py-2 sm:py-3 text-center font-semibold">Evaluasi</th>
                        @endif
                    </tr>
                </thead>
                <tbody>
                        ...
                        <td class="border border-gray-300 px-2 sm:px-4 py-2 sm:py-3 text-center">
                            <div class="flex flex-wrap justify-center gap-1 sm:gap-2">
                                ...
                                <form action="{{ route('prosedur-pengawasan.delete', $prosedur->id) }}"
                                    ...
                                    @method('DELETE')
                                    <button type="submit"
                                            class="bg-red-500 hover:bg-red-600 text-white px-2 sm:px-3 py-1 rounded font-semibold text-xs sm:text-sm transition">
                                        Hapus
                                    </button>
                                </form>
                                @endif
                        ...
                        <td class="border border-gray-300 px-2 sm:px-4 py-2 sm:py-3 text-center">
                            ...
                            @if ($isPeriodeActive and $prosedur->status == 'disetujui')
                                <a href="{{ route('monitoring-evaluasi.create', $prosedur->id) }}"
                                   class="bg-purple-500 hover:bg-purple-600 text-white px-2 sm:px-3 py-1 rounded text-xs sm:text-sm transition">
                                    Evaluasi
                                </a>
                            @endif
                        </td>
                    ...
                    <tr>
                        <td colspan="{{ Auth::user()->role == 'pjk' ? '8' : '7' }}" class="border border-gray-300 px-4 py-8 text-center text-gray-500">
                            <div class="flex flex-col items-center">
                                ...
                                <p class="text-base sm:text-lg font-medium">Belum ada prosedur pengawasan</p>
                                <p class="text-xs sm:text-sm">Klik "Tambah" untuk membuat prosedur pengawasan baru</p>
                            </div>
                        </td>
                    </tr>
                    @endif
