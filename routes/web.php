...
Route::middleware('auth','role:admin')->group(function () {
    Route::get('/admin/dashboard', function () {return view('admin.dashboard', ['title' => 'Dashboard']);});
...
Route::middleware('auth','role:pjk')->group(function () {
    Route::get('/penanggungjawab/dashboard', function () {return view('penanggungjawab.dashboard', ['title' => 'Dashboard']);});
...
Route::middleware('auth','role:perencana')->group(function () {
    Route::get('/perencana/dashboard', function () {return view('perencana.dashboard', ['title' => 'Dashboard']);});
    ...
    Route::get('/perencana/daftarinstrumenpengawasan/{id}', [InstrumenPengawasanController::class, 'show'])->name('perencana.instrumen-pengawasan.detail');
    Route::post('/perencana/daftarinstrumenpengawasan', [InstrumenPengawasanController::class, 'store'])->name('instrumen-pengawasan.store');
    Route::get('/perencana/daftarinstrumenpengawasan/{id}/edit', [InstrumenPengawasanController::class, 'edit'])->name('perencana.instrumen-pengawasan.edit');
...
Route::middleware('auth','role:pegawai')->group(function () {
    Route::get('/pegawai/dashboard', function () {return view('pegawai.dashboard', ['title' => 'Dashboard']);});
